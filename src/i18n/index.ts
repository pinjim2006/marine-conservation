...
export const ui = {
  ...
  en: {
    ...
    'home.reality.desc': 'Microplastics, overfishing, and warming waters are changing the catch structure simultaneously. Many older fishers say that in the last decade, the fish caught are "getting smaller, fewer, and more unpredictable."',
    'home.reality.1.title': 'Decline in Coastal Fish Populations',
    'home.reality.1.desc': 'Coastal fish density is dropping, forcing fishing boats to spend more on fuel to go further and work longer hours.',
    'home.reality.2.title': 'Increase in Bycatch and Debris',
    'home.reality.2.desc': 'Nets bring back more non-target marine life and plastic waste, harming the ecosystem and squeezing fishers\' profits.',
    'home.reality.3.title': 'Rising Livelihood Uncertainty',
    'home.reality.3.desc': 'Shorter fishing seasons and volatile fish prices make it harder for younger generations to join, causing local cultures to slowly fade away.',
    ...
    'home.action.list.2': 'Support certified sustainable seafood to let the market reflect ecological value.',
    'home.action.list.3': 'Share credible news and data to raise marine awareness among people around you.',

    // Latest News 區塊
    'home.news.kicker': 'Latest News',
    'home.news.title': 'Turn Ocean News into Actionable Information',
    'home.news.desc': 'Curated latest marine conservation and fisheries news to help you quickly grasp policy, environmental, and ecological changes.',
  }
} as const;
